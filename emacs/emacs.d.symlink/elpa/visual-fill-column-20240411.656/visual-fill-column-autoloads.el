...
With prefix ARG, enable Global Visual-Fill-Column mode if ARG is positive; otherwise, disable
it.
...
Visual-Fill-Column mode is enabled in all buffers where `turn-on-visual-fill-column-mode' would
do it.
